...
public class ScoreCoralTeleopCommand extends Command {
  ...
  public ScoreCoralTeleopCommand(Intake intake) {
    this.intake = intake;
  }
  ...
  public void execute() {
    ...
    // WAIT FOR preset, log the time it takes waiting for the arm to get in position...
