...
public class AutoPathConditional {
  ...
  private static final double LOW_SCORE_EXTRA_TIME_TO_BE_SAFE = .1 + .05;
  ...
  private Command createHighScoreCommand() {
    Command highScoreCommand =
        new SequentialCommandGroup(
            ...
            new TimedWaitUntilCommand("High Score/atGoal", coralSystem::isAtGoal),
            new ScoreCoralInAutoCommand(coralSystem.getIntake()),
            new RunPresetCommand(coralSystem, CoralSystemPresets.PICKUP));
  ...
  private Command createLowScoreCommand() {
    Command lowScoreCommand =
        new SequentialCommandGroup(
            ...
            new TimedWaitUntilCommand("Low Score/atGoal", coralSystem::isAtGoal),
            new ScoreCoralInAutoCommand(coralSystem.getIntake()),
            new RunPresetCommand(coralSystem, CoralSystemPresets.PICKUP));
