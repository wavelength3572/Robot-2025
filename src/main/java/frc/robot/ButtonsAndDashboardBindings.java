...
public class ButtonsAndDashboardBindings {
    ...
    private static void SetupAlignmentButtons() {
        ...
        alignmentChooser.setDefaultOption("AlignAndScorePP", (isLeftPole) -> AlignAndScorePP.create(drive, coralSystem, isLeftPole));
        alignmentChooser.addOption("AlignAndScore", (isLeftPole) -> AlignAndScore.create(drive, coralSystem, isLeftPole));
        ...
        ChooserAlignmentCommand alignRightCommand = new ChooserAlignmentCommand(alignmentChooser, false);
